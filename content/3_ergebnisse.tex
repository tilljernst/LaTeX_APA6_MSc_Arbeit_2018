...
\begin{tikzpicture}[scale=.8, auto,swap]
  ...
  \end{axis}
\end{tikzpicture}
\captionsetup{margin={100pt,20pt}}
...
Neben der Mediennutzung und der Medientätigkeit wurde die Anzahl Geräte im Haushalt erfragt (detaillierte Auflistung siehe Tabelle \ref{fig:AppGeräteHaushalt} im Anhang). Dabei gaben 83.9 \% der Befragten an, zwei Smartphones im Haushalt zu besitzen. 70.2 \% gaben an, ein TV-Gerät zu besitzen. 45 \% besitzen zwei Computer (Desktop oder Laptop), 45.9 \% ein Tablet und 48.2 \% ein Radio (Stereoanlage, CD-Player) im Haushalt. 51.4 \% gaben an, keine Tageszeitung oder ein Magazin abonniert zu haben. 45.9 \% gaben an, einen Fotoapparat oder eine Videokamera zu besitzen. 61 \% besitzen keine Spielekonsole und 67 \% keinen MP3-Player.

Zudem wurden die Medien erhoben, auf welche die Eltern während der Betreuung am wenigsten verzichten konnten (siehe Tabelle \ref{fig:AppMedienverzicht} im Anhang). 85.3 \% gaben an, nicht auf das Smartphone verzichten zu können, gefolgt von Radio 33.9 \% (Stereoanlage, CD-Player) und 25.2 \% Foto- und Videokamera. Nicht verzichten können 11.9 \% der Teilnehmenden auf den Fernseher, 9.6 \% auf das Abonnement einer Tageszeitung oder Zeitschrift, 8.3 \% nicht auf den Computer (Laptop oder Desktop), 2.8 \% auf den MP3-Player, 2.3 \% auf das Tablet und 0.9 \% auf die Spielekonsole.
