...
Die im Folgenden dargestellte \acrfull{aas} wurde aus der Validierungsstudie von \citeA{Schmidt2004}, des originalen Instruments von \citeA{Collins1990} übernommen. Die Spalte \enquote{Orig.} in Tabelle \titleref{table:AASItems} beinhaltet die originale Nummerierung der Fragebogenitems. Die Spalte \enquote{Nr.} beinhaltet die neue Nummerierung, so wie sie im Umfragebogen (siehe auch \titleref{app:Fragebogen}) verwendet wurde.
